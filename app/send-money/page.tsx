...
const SendMoney: React.FC = () => {
  ...
  const recentTransactions: Transaction[] = [
    { id: 1, recipient: 'John Doe', amount: 150.00, date: '2 days ago', status: 'completed', type: 'sent' },
    { id: 2, recipient: 'Sarah Smith', amount: 75.50, date: '5 days ago', status: 'completed', type: 'sent' },
    { id: 3, recipient: 'Mike Johnson', amount: 200.00, date: '1 week ago', status: 'completed', type: 'sent' },
    { id: 4, recipient: 'Emily Davis', amount: 50.00, date: '2 weeks ago', status: 'pending', type: 'sent' },
  ];
  ...
  const confirmSend = async () => {
    ...
    try {
      ...
      setTimeout(() => {
        setIsSuccess(false);
        setFormData({ recipient: "", amount: "", note: "", paymentMethod: 'bank', scheduleDate: '' });
